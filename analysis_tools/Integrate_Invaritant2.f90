...
do k=0,Nz-1
  ...
  open(11, file = "/Users/isseyshome/Downloads/kari/parameter"//trim(M_number)//"_"//trim(z_name)//".txt")
  !入力データの読み込みと確認
  do i=0,Ny
    do j = 0,Nx
      !通常はこちら
...
!複数の2次元txtファイルから第二不変量と座標のみを1つのparticlesファイルにまとめる時はこちら
open(97, file = "/Users/isseyshome/Documents/GitHub/Inoue_Lab/3dimensions/result_analysis/"&
          //trim(folder_name)//"_2ndInvaritant"//trim(M_number)//".particles")
open(98, file = "/Users/isseyshome/Documents/GitHub/Inoue_Lab/3dimensions/result_analysis/"&
