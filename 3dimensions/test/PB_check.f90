...
program iryuu6
implicit none
integer i,M,j,k,im1,im2,ip1,ip2
double precision dz,pi,dzinv
double precision sigma,alpha5,Dalpha,usum,lsum
...
alpha5 = 1.d0/3.d0;Dalpha = 1.d0;sigma=0.25d0
