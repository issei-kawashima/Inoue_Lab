...
se output "/Users/isseyshome/Documents/Lab/ex_19/p.gif"	#!出力先ファイル名の設定
#se pm3d map
#!表示領域の設定
se zr [0:1.2]
set cbrange [0:1.2]
...
do for[i = st : to : offset]{
	input1 = sprintf("/Users/isseyshome/Documents/Lab/ex_19/result_file/p%05d.d", i)
	time =sprintf("t = %.1f",i/10000.0)
