...
se output "/Users/isseyshome/Documents/Lab/2dimensions/u.gif"	#!出力先ファイル名の設定
...
se xr[0:24]
se yr[-8:8]
set cbrange [-0.4:1.2]#色分けする範囲の設定
set xlabel 'x'
set ylabel 'y'
set zlabel 'u'
set ticslevel 0
...
set palette defined (-0.4"blue",0"white",1.2"red")
...
se cntrparam levels incremental -0.5,0.2,1#等高線の初期値、間隔、最終値の設定
...
do for[i = st : to : offset]{
	input1 = sprintf("/Users/isseyshome/Documents/Lab/2dimensions/result_super/parameter%06d.d", i)
	time =sprintf("t = %.1f",i/200.0)
